...
router.post('/api/content', auth.requireAuth, validateCsrf, (req, res) => {
  try {
    ...
    const ALLOWED_KEYS = ['brand', 'hero', 'metrics', 'features', 'pricing', 'testimonials', 'faq', 'faqs', 'contact', 'seo', 'countdown', 'gallery', 'sponsors', 'footer', 'venue', 'sections', 'video', 'construction', 'schedule', 'scheduleSection', 'categories'];
    const filtered = {};
