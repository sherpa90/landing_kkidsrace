...
function collectCmsFormData() {
  ...
  return {
    ...
    registrationForm: {
      ...
      accountHolder: getVal('input-reg-accountHolder') || 'Sandra Arriagada Cárdenas',
      accountRut: getVal('input-reg-accountRut') || '11.923.718-1',
      bankName: getVal('input-reg-bankName') || 'Banco Santander',
      accountType: getVal('input-reg-accountType') || 'Cuenta Corriente',
      accountNumber: getVal('input-reg-accountNumber') || '67734912',
      pricePerParticipant: getVal('input-reg-pricePerParticipant') || '$15.000',
      receiptEmail: getVal('input-reg-receiptEmail') || 'kkidsrace@gmail.com',
